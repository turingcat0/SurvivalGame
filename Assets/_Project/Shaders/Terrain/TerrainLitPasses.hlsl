...
#include "Assets/_Project/Shaders/SkyAtmosphere/SkyAtmosphereFog.hlsl"
...
void SplatmapFinalColor(inout half4 color, float4 fogColor)
{
    color.rgb *= color.a;
...
Varyings SplatmapVert(Attributes v)
{
    ...
    #endif
    SKY_ATMOSPHERE_INIT_FOG(o, Attributes);
...
#endif
{
    ...
    SplatmapFinalColor(color, inputData.fogCoord);
    SKY_ATMOSPHERE_APPLY_FOG(IN, color);
